...
def read_uf2(filename):
    ...
    for block in blocks:
        ...
        # print(f"> {magic_start_0:#0x} {magic_start_1:#0x} {flags:#0x} {target_address:#0x} {payload_size:#0x} {block_no:#0x} {num_blocks:#0x} {family_id:#0x}")
        ...
        data_blocks.append(block[DATA_START_OFFSET:DATA_START_OFFSET + payload_size])
